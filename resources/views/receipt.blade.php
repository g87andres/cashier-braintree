	...
	<table style="margin-left: auto; margin-right: auto" width="550">
		<tr>
			...
			<td align="right">
				...
				<img src="{{ public_path('img/logo-black.png') }}"> {{-- must be absolute path for image to show in PDF --}}
			</td>
		</tr>
		<tr valign="top">
		...
		<tr>
			<td colspan="2">
				...
				<table width="100%" class="table" border="0">
					...
					<tr>
						<td>Training Plan Subscription</td>
						<td>
							@if($subscription->billingPeriodStartDate && $subscription->billingPeriodEndDate)
								{{ $subscription->billingPeriodStartDate->format('M jS, Y') }}
								-
								{{ $subscription->billingPeriodEndDate->format('M jS, Y') }}
							@endif
						</td>
						<td>
